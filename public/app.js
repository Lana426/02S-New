  ...
  function renderLogPlan(){
    ...
    if(ns){
      ...
      // v1: GC/GR services (list/gantt) + delivery tracker at bottom
      ...
      h+='<span style="font-size:11.5px;color:var(--g400);margin-left:6px">'+GCGR_SERVICES.length+' services</span>';
