...
charges:[
  ...
  function ccLookaheadHTML(proj,ns){
    ...
    var h='';
    h+='<div id="cc-la-wrap" style="background:#fff;border:1px solid var(--g200);border-radius:8px;padding:16px 18px;height:100%;box-sizing:border-box;display:flex;flex-direction:column">';
