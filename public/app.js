...
function ctFpaFeature(k){
  var M={
    consolidated:{title:'Consolidated plan',sub:'02S → Anaplan · one source of truth',body:'<div class="list" style="margin-bottom:14px"><div class="lrow lhead" style="grid-template-columns:1fr 1fr"><div>02S pillar</div><div>Plan value</div></div><div class="lrow" style="grid-template-columns:1fr 1fr"><div class="lrow-pri">Equipment</div><div>$524M</div></div><div class="lrow" style="grid-template-columns:1fr 1fr"><div class="lrow-pri">Procurement</div><div>$380M</div></div><div class="lrow" style="grid-template-columns:1fr 1fr"><div class="lrow-pri">Logistics</div><div>$223M</div></div><div class="lrow" style="grid-template-columns:1fr 1fr"><div class="lrow-pri">Prefabrication</div><div>$95M</div></div><div class="lrow" style="grid-template-columns:1fr 1fr"><div class="lrow-pri">Prof. Services</div><div>$88M</div></div></div><div class="ai-panel"><div class="aih"><div class="ico">'+ctIc('sparkle',16)+'</div><div class="t">How it works</div></div><div class="ctx" style="margin-bottom:0">02S rolls up all margin plans by pillar and submits a single consolidated plan to Anaplan — no manual re-entry, no version mismatch. The plan in Anaplan <em>is</em> the 02S plan.</div></div>'},
    reporting:{title:'Financial reporting',sub:'02S_FY25_Plan_v3 · last run May 20, 2025',body:'<div class="ct-guardrails" style="margin-bottom:14px"><div class="grd"><div class="grd-ico ok">'+ctIc('check',16)+'</div><div class="grd-l">Revenue — on plan</div><div class="grd-b"><div class="grd-fill ok" style="width:88%"></div></div></div><div class="grd"><div class="grd-ico warn">'+ctIc('warning',16)+'</div><div class="grd-l">Margin — 40 bps under</div><div class="grd-b"><div class="grd-fill warn" style="width:62%"></div></div></div><div class="grd"><div class="grd-ico ok">'+ctIc('check',16)+'</div><div class="grd-l">SG&A — under budget</div><div class="grd-b"><div class="grd-fill ok" style="width:75%"></div></div></div></div><div class="ai-panel"><div class="aih"><div class="ico">'+ctIc('sparkle',16)+'</div><div class="t">How it works</div></div><div class="ctx" style="margin-bottom:0">Financial reporting runs from Anaplan against the 02S-submitted plan. Actuals land in the same model — so variance is calculated automatically and leadership sees plan vs. actual in one view.</div></div>'},
    scenario:{title:'Scenario modeling',sub:'base · upside · downside',body:'<div class="scn-toggle" style="margin-bottom:12px"><button class="on" onclick="this.parentElement.querySelectorAll(\'button\').forEach(function(b){b.classList.remove(\'on\')});this.classList.add(\'on\');document.getElementById(\'fpaScnGrid\').innerHTML=\'<div class=\'scn-cell\'><div class=\'scn-k\'>Revenue</div><div class=\'scn-v\'>$4.77B</div></div><div class=\'scn-cell\'><div class=\'scn-k\'>Op. margin</div><div class=\'scn-v\'>7.6%</div></div><div class=\'scn-cell\'><div class=\'scn-k\'>Op. profit</div><div class=\'scn-v\'>$362M</div></div><div class=\'scn-note\'>Weighted pipeline as planned.</div>\'">Base</button><button onclick="this.parentElement.querySelectorAll(\'button\').forEach(function(b){b.classList.remove(\'on\')});this.classList.add(\'on\');document.getElementById(\'fpaScnGrid\').innerHTML=\'<div class=\'scn-cell\'><div class=\'scn-k\'>Revenue</div><div class=\'scn-v\'>$5.02B</div></div><div class=\'scn-cell\'><div class=\'scn-k\'>Op. margin</div><div class=\'scn-v ok\'>8.1%</div></div><div class=\'scn-cell\'><div class=\'scn-k\'>Op. profit</div><div class=\'scn-v ok\'>$407M</div></div><div class=\'scn-note\'>Fountain Valley + 1 pursuit convert.</div>\'">Upside</button><button onclick="this.parentElement.querySelectorAll(\'button\').forEach(function(b){b.classList.remove(\'on\')});this.classList.add(\'on\');document.getElementById(\'fpaScnGrid\').innerHTML=\'<div class=\'scn-cell\'><div class=\'scn-k\'>Revenue</div><div class=\'scn-v\'>$4.41B</div></div><div class=\'scn-cell\'><div class=\'scn-k\'>Op. margin</div><div class=\'scn-v red\'>7.0%</div></div><div class=\'scn-cell\'><div class=\'scn-k\'>Op. profit</div><div class=\'scn-v red\'>$309M</div></div><div class=\'scn-note\'>Two jobs slip; re-rent premium rises.</div>\'">Downside</button></div><div class="scn-grid" id="fpaScnGrid"><div class="scn-cell"><div class="scn-k">Revenue</div><div class="scn-v">$4.77B</div></div><div class="scn-cell"><div class="scn-k">Op. margin</div><div class="scn-v">7.6%</div></div><div class="scn-cell"><div class="scn-k">Op. profit</div><div class="scn-v">$362M</div></div><div class="scn-note">Weighted pipeline as planned.</div></div>'},
    insights:{title:'Performance insights',sub:'02S analytics layer · powered by Anaplan',body:'<div class="edp-stats" style="margin-bottom:14px"><div class="edp-stat"><div class="k">Win rate</div><div class="n">62%</div><div class="s">vs 58% last year</div></div><div class="edp-stat cost"><div class="k">Margin gap</div><div class="n">−40 bps</div><div class="s">vs plan · Equipment</div></div><div class="edp-stat"><div class="k">Pipeline coverage</div><div class="n">3.6×</div><div class="s">vs target 3.0×</div></div><div class="edp-stat"><div class="k">Plans submitted</div><div class="n">226</div><div class="s">of 634 opps</div></div></div><div class="ai-panel"><div class="aih"><div class="ico">'+ctIc('sparkle',16)+'</div><div class="t">How it works</div></div><div class="ctx" style="margin-bottom:0">Performance insights combine the 02S pipeline data with Anaplan actuals to surface win rates, margin gaps, and coverage ratios — updated as opportunities move through stages.</div></div>'}
  }[k];
  if(!M)return;
